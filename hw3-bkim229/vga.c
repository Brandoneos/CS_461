...
ushort textBuffer[2000];
static ushort *crt = (ushort*)P2V(0xb8000);  // CGA memory
#define CRTPORT 0x3d4
int cursorPos;
void cgaSavePalette()
{
	//modify this to save the text too
	// memmove(void *vdst, void *vsrc, int n)

	//Saves the text buffer crt into textBuffer
	memmove(textBuffer,crt,4000);
	outb(CRTPORT, 14);
